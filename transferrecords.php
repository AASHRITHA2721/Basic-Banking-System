...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:orange; opacity:1;"> 
            ...
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:black;font-family: 'Times New Roman', Times, serif;font-size:2em;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="color:black;font-weight:1em;">
                            <div style="padding-left:20px;" >
                                <img height="60" width="60" src="customer.png">
                            </div>
                            Customer Details
                        </a> 
                    </li>
...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:black;font-family: 'Courgette', cursive;font-size:2.2em;padding:3%;">Transaction History</h3>
    <table id="myTable">
          <tr>
            <th>Sender</th>
            <th>Receiver</th>
