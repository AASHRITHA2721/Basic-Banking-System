<?php
    $con = mysqli_connect("localhost", "root", "9741", "mybank");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:orange; opacity:1;"> 
            ...
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:burgundy;font-family:'Times New Roman', Times, serif;font-size:2em;">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                <ul class="navbar-nav ml-auto font-weight-bold"  style="font-size:small; color:white; "> 
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:black;font-weight:1em;">
                            <div style="padding-right:0px;" >
                                <img height="60"src="1icon.jpg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:black;font-weight:1em;">
                            <div style="padding-left:20px;" >
                                <img height="60"src="transfer.png">
                            </div>
                            Transaction History
                        </a> 
                    </li>  
...
<div class='usertable'>
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:Black;font-family: 'Courgette', cursive;font-size:2.2em;padding:3%;">Customers</h3>
    <table id="Mytable">
          <tr>
            <th>Customer ID</th>
            <th>Name</th>
